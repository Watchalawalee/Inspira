...
import { Box, Toolbar, IconButton, InputBase, Paper, Menu, MenuItem } from '@mui/material';
...
const BannerSlider: React.FC = () => {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute left-80 top-10 h-full w-full md:w-1/3 lg:w-1/4 bg-[rgba(83,114,164,0.5)] flex flex-col justify-start items-center px-6 py-10 text-white transform -translate-x-1/2">  <img
    src="/logo.svg"
    alt="Logo"
    style={{
